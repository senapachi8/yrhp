...
if ('/Applications/MAMP/bin/php/php8.2.0/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/Applications/MAMP/bin/php/php8.2.0/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
